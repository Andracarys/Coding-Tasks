...
# You might find it helpful to test your program on,
# e.g., some of Week 6’s source code as well as on programs of your own.
...
# line.lstrip()  # removes leading whitespace from the line
# stripped_line.startswith("#")  # checks if the line starts with a comment character
